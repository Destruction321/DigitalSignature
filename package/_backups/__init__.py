# package/_backups/__init__.py
"""数字签名窗口备份方法模块"""
from tkinter import Menu, messagebox, Widget
from tkinter.ttk import Button, Label
from typing import cast, Callable, TYPE_CHECKING

from .dialog import show
from ._backup_utils import create_backup, list_backups_with_integrity
...
class BackUps:
    ...
    def backup_manager_dialog(self) -> None:
        ...
        show(parent_window, self.__ui_state_mgr.update_status)
